...
pub fn builtinEncodingList(vm: *VM, _: Value, args: []Value, _: ?Block) VMError!Value {
    ...
    const encodings = [_]Value{
        ...
        Value.fromObject(&vm.encoding_windows_1252.object),
        Value.fromObject(&vm.encoding_euc_jp.object),
        Value.fromObject(&vm.encoding_gb18030.object),
        Value.fromObject(&vm.encoding_gbk.object),
        Value.fromObject(&vm.encoding_big5.object),
