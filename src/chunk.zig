...
pub const Chunk = struct {
    ...
    fn disassembleInstruction(self: *Chunk, ip: usize, instr_idx: usize, writer: *std.Io.Writer) !usize {
        ...
        switch (op) {
            ...
            .PUSH_INT, .PUSH_CONST, .GET_CONST, .SET_CONST, .GET_CONST_PATH, .GET_GLOBAL, .SET_GLOBAL, .GET_IVAR, .SET_IVAR => {
            ...
            .GET_LOCAL, .SET_LOCAL, .PUSH_ARRAY, .PUSH_HASH, .RAISE, .CATCH_START => {
