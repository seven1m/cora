...
pub const CALL_NODE_FLAGS_VARIABLE_CALL = c.PM_CALL_NODE_FLAGS_VARIABLE_CALL;
pub const LOOP_FLAGS_BEGIN_MODIFIER = c.PM_LOOP_FLAGS_BEGIN_MODIFIER;
pub const ARGUMENTS_NODE_FLAGS_CONTAINS_KEYWORDS = c.PM_ARGUMENTS_NODE_FLAGS_CONTAINS_KEYWORDS;
pub const ARGUMENTS_NODE_FLAGS_CONTAINS_KEYWORD_SPLAT = c.PM_ARGUMENTS_NODE_FLAGS_CONTAINS_KEYWORD_SPLAT;
...
pub const ForwardingArgumentsNode = c.pm_forwarding_arguments_node_t;
...
pub const Node = union(enum) {
    ...
    forwarding_arguments: *ForwardingArgumentsNode,
...
pub const Parser = struct {
    ...
    pub fn asNode(self: *Parser, raw: *RawNode) !Node {
        ...
        if (node_type == c.PM_FORWARDING_ARGUMENTS_NODE) {
            return Node{ .forwarding_arguments = @ptrCast(raw) };
        }
