...
const bundled_gems_test = @import("bundled_gems_test.zig");
...
const core_marshal_test = @import("core/marshal_test.zig");
...
const language_class_variable_test = @import("language/class_variable_test.zig");
...
const language_for_test = @import("language/for_test.zig");
...
const language_redo_test = @import("language/redo_test.zig");
const language_return_test = @import("language/return_test.zig");
...
const language_undef_test = @import("language/undef_test.zig");
...
comptime {
    ...
    _ = language_class_variable_test;
