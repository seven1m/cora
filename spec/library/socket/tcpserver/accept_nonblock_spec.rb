...
describe "Socket::TCPServer.accept_nonblock" do
  ...
  it "accepts non blocking connections" do
    CORAFIXME "TCPServer#listen, TCPSocket#getsockname, and Socket.unpack_sockaddr_in are not implemented yet", exception: NoMethodError, message: /undefined method '(listen|getsockname|unpack_sockaddr_in)'/ do
      @server.listen(5)
      -> {
    ...
    platform_is_not :windows do # spurious
      describe 'with a connected client' do
        it 'returns a TCPSocket' do
          CORAFIXME "IPSocket#connect_address is not implemented yet", exception: NoMethodError, message: /undefined method 'connect_address'/ do
