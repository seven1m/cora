...
describe "IO.popen" do
  ...
  it "sees an infinitely looping subprocess exit when read pipe is closed" do
    CORAFIXME "IO.popen close does not reliably terminate a long-running child yet", exception: NotImplementedError, message: /long-running child/ do
      raise NotImplementedError, "long-running child shutdown is not implemented"
  ...
  it "reads and writes a read/write pipe" do
    CORAFIXME "IO.popen r+ still deadlocks on duplex streaming", exception: NotImplementedError, message: /duplex streaming/ do
      raise NotImplementedError, "duplex streaming is not implemented"
  ...
  platform_is_not :windows do
    it "starts returns a forked process if the command is -" do
      CORAFIXME "IO.popen(\"-\") is not implemented yet", exception: NotImplementedError, message: /IO\.popen\("-"\)/ do
        raise NotImplementedError, 'IO.popen("-") is not implemented'
        io = IO.popen("-")
  ...
  context "with a leading Array argument" do
    ...
    it "accepts a trailing Hash of Process.exec options" do
      CORAFIXME "missing file errors are not LoadError yet" do
