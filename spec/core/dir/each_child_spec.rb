...
describe "Dir#each_child" do
  ...
  it "yields all names in an existing directory to the provided block" do
    CORAFIXME "Dir.new(path) is not implemented", exception: ArgumentError, message: /wrong number of arguments/ do
      a, b = [], []
  ...
  it "returns the same result when called repeatedly" do
    CORAFIXME "Dir.open is not implemented", exception: NoMethodError, message: /private method `open' called/ do
