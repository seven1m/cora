...
describe :regexp_new_string, shared: true do
  ...
  it "raises a RegexpError when passed an incorrect regexp" do
    CORAFIXME "Onigmo RegexpError messages do not yet include MRI's pattern suffix", exception: RegexpError, message: "premature end of char-class" do
  ...
  describe "with escaped characters" do
    it "raises a Regexp error if there is a trailing backslash" do
      CORAFIXME "Onigmo RegexpError messages do not yet include MRI's pattern suffix", exception: RegexpError, message: "end pattern at escape" do
    ...
    it "raises a RegexpError if \\x is not followed by any hexadecimal digits" do
      CORAFIXME "Onigmo accepts \\x without hexadecimal digits instead of raising invalid hex escape", exception: SpecExpectationNotMetError, message: /no exception was raised/ do
    ...
    it "raises a RegexpError if less than four digits are given for \\uHHHH" do
      CORAFIXME "Onigmo RegexpError messages do not yet include MRI's specific invalid Unicode details", exception: RegexpError, message: "too short digits" do
