...
# NOTE: The shared kernel_raise, kernel_raise_across_contexts, and
# kernel_raise_with_cause examples (spec/shared/kernel/raise.rb) also apply
# to Thread#raise but require cause kwarg forwarding, backtrace_locations,
# and non-Exception arg handling not yet ported.
