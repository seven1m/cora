...
- [x] core/array/bsearch_index_spec.rb
...
- [x] core/array/equal_value_spec.rb
...
- [x] core/array/intersection_spec.rb
...
- [x] core/array/minmax_spec.rb
- [x] core/array/minus_spec.rb
...
### core/array
- [x] core/array/partition_spec.rb
- [x] core/array/permutation_spec.rb
...
- [x] core/array/repeated_combination_spec.rb
- [x] core/array/repeated_permutation_spec.rb
- [x] core/array/replace_spec.rb
- [x] core/array/reverse_each_spec.rb
- [x] core/array/reverse_spec.rb
- [x] core/array/rfind_spec.rb
- [x] core/array/rindex_spec.rb
- [x] core/array/rotate_spec.rb
- [ ] core/array/sample_spec.rb
- [x] core/array/select_spec.rb
- [x] core/array/shift_spec.rb
- [x] core/array/shuffle_spec.rb
...
- [ ] core/binding/implicit_parameter_defined_spec.rb
- [ ] core/binding/implicit_parameter_get_spec.rb
- [ ] core/binding/implicit_parameters_spec.rb
...
- [x] core/binding/source_location_spec.rb
...
### core/comparable
- [x] core/comparable/between_spec.rb
- [x] core/comparable/clamp_spec.rb
- [x] core/comparable/equal_value_spec.rb
...
- [x] core/complex/denominator_spec.rb
...
- [x] core/complex/inspect_spec.rb
...
- [x] core/enumerable/drop_while_spec.rb
- [x] core/enumerable/each_cons_spec.rb
- [x] core/enumerable/each_entry_spec.rb
- [x] core/enumerable/each_slice_spec.rb
- [x] core/enumerable/each_with_index_spec.rb
- [x] core/enumerable/each_with_object_spec.rb
- [x] core/enumerable/entries_spec.rb
...
- [x] core/enumerable/first_spec.rb
- [x] core/enumerable/flat_map_spec.rb
- [x] core/enumerable/grep_spec.rb
- [x] core/enumerable/grep_v_spec.rb
- [x] core/enumerable/group_by_spec.rb
...
- [x] core/enumerable/max_by_spec.rb
- [x] core/enumerable/max_spec.rb
- [x] core/enumerable/member_spec.rb
- [x] core/enumerable/min_by_spec.rb
- [x] core/enumerable/min_spec.rb
- [x] core/enumerable/minmax_by_spec.rb
- [x] core/enumerable/minmax_spec.rb
...
- [x] core/enumerable/to_h_spec.rb
- [x] core/enumerable/to_set_spec.rb
- [x] core/enumerable/uniq_spec.rb
...
- [x] core/env/clone_spec.rb
- [x] core/env/delete_if_spec.rb
...
- [x] core/env/element_reference_spec.rb
...
- [ ] core/fiber/current_scheduler_spec.rb
...
- [x] core/file/stat/blocks_spec.rb
- [x] core/file/stat/chardev_spec.rb
- [x] core/file/stat/comparison_spec.rb
- [x] core/file/stat/ctime_spec.rb
- [x] core/file/stat/dev_major_spec.rb
- [x] core/file/stat/dev_minor_spec.rb
- [x] core/file/stat/dev_spec.rb
- [x] core/file/stat/directory_spec.rb
- [x] core/file/stat/executable_real_spec.rb
...
- [x] core/file/stat/inspect_spec.rb
- [x] core/file/stat/mode_spec.rb
- [x] core/file/stat/mtime_spec.rb
- [x] core/file/stat/new_spec.rb
- [x] core/file/stat/nlink_spec.rb
- [x] core/file/stat/owned_spec.rb
- [x] core/file/stat/pipe_spec.rb
- [x] core/file/stat/rdev_major_spec.rb
- [x] core/file/stat/rdev_minor_spec.rb
- [x] core/file/stat/rdev_spec.rb
- [x] core/file/stat/readable_real_spec.rb
...
- [x] core/file/stat/writable_real_spec.rb
...
- [x] core/file/writable_real_spec.rb
- [x] core/file/writable_spec.rb
- [x] core/file/zero_spec.rb
...
- [x] core/filetest/executable_real_spec.rb
- [x] core/filetest/executable_spec.rb
- [x] core/filetest/exist_spec.rb
- [x] core/filetest/file_spec.rb
- [x] core/filetest/grpowned_spec.rb
- [x] core/filetest/identical_spec.rb
- [x] core/filetest/owned_spec.rb
- [x] core/filetest/pipe_spec.rb
- [x] core/filetest/readable_real_spec.rb
- [x] core/filetest/readable_spec.rb
- [x] core/filetest/setgid_spec.rb
- [x] core/filetest/setuid_spec.rb
- [x] core/filetest/size_spec.rb
- [x] core/filetest/socket_spec.rb
- [x] core/filetest/sticky_spec.rb
- [x] core/filetest/symlink_spec.rb
- [x] core/filetest/world_readable_spec.rb
- [x] core/filetest/world_writable_spec.rb
- [x] core/filetest/writable_real_spec.rb
- [x] core/filetest/writable_spec.rb
- [x] core/filetest/zero_spec.rb

### core/float
- [x] core/float/abs_spec.rb
- [x] core/float/angle_spec.rb
- [x] core/float/arg_spec.rb
...
- [x] core/float/magnitude_spec.rb
- [x] core/float/minus_spec.rb
- [x] core/float/modulo_spec.rb
- [x] core/float/multiply_spec.rb
- [x] core/float/nan_spec.rb
- [x] core/float/negative_spec.rb
- [x] core/float/next_float_spec.rb
- [x] core/float/numerator_spec.rb
...
- [x] core/hash/filter_spec.rb
- [x] core/hash/flatten_spec.rb
- [x] core/hash/gt_spec.rb
- [x] core/hash/gte_spec.rb
...
- [x] core/hash/slice_spec.rb
- [x] core/hash/sort_spec.rb
- [x] core/hash/store_spec.rb
...
- [ ] core/integer/bit_count_spec.rb
...
- [x] core/integer/lt_spec.rb
- [x] core/integer/lte_spec.rb
- [x] core/integer/magnitude_spec.rb
...
- [x] core/io/autoclose_spec.rb
- [-] core/io/binmode_spec.rb
- [x] core/io/binread_spec.rb
- [x] core/io/binwrite_spec.rb

### core/io/buffer
- [ ] core/io/buffer/and_spec.rb
- [ ] core/io/buffer/bit_count_spec.rb
...
- [ ] core/kernel/autoload_relative_spec.rb
...
- [x] core/kernel/remove_instance_variable_spec.rb
...
### core/matchdata
- [x] core/matchdata/allocate_spec.rb
...
- [x] core/matchdata/dup_spec.rb
- [x] core/matchdata/element_reference_spec.rb
- [x] core/matchdata/end_spec.rb
...
- [ ] core/method/source_range_spec.rb
- [ ] core/method/super_method_spec.rb
- [ ] core/method/syntax_tree_spec.rb
...
- [ ] core/module/autoload_relative_spec.rb
...
- [x] core/module/public_instance_method_spec.rb
...
- [x] core/numeric/angle_spec.rb
- [x] core/numeric/arg_spec.rb
- [x] core/numeric/ceil_spec.rb
...
- [x] core/numeric/modulo_spec.rb
- [x] core/numeric/negative_spec.rb
- [x] core/numeric/nonzero_spec.rb
- [x] core/numeric/numerator_spec.rb
- [x] core/numeric/numeric_spec.rb
- [x] core/numeric/phase_spec.rb
- [x] core/numeric/polar_spec.rb
...
- [x] core/numeric/remainder_spec.rb
- [x] core/numeric/round_spec.rb
- [ ] core/numeric/singleton_method_added_spec.rb
- [ ] core/numeric/step_spec.rb
- [x] core/numeric/to_c_spec.rb
...
- [x] core/range/case_compare_spec.rb
- [ ] core/range/clamp_spec.rb
- [x] core/range/clone_spec.rb
- [x] core/range/count_spec.rb
- [x] core/range/cover_spec.rb
- [x] core/range/dup_spec.rb
- [x] core/range/each_spec.rb
- [x] core/range/end_spec.rb
- [x] core/range/entries_spec.rb
...
- [x] core/rational/divmod_spec.rb
- [x] core/rational/equal_value_spec.rb
- [x] core/rational/exponent_spec.rb
...
- [x] core/regexp/equal_value_spec.rb
...
### core/ruby/source_range
- [ ] core/ruby/source_range/inspect_spec.rb
...
- [x] core/string/partition_spec.rb
...
- [ ] core/string/unpack/carret_spec.rb
...
- [x] core/struct/deconstruct_keys_spec.rb
- [x] core/struct/deconstruct_spec.rb
- [x] core/struct/dig_spec.rb
...
- [x] core/struct/eql_spec.rb
- [x] core/struct/equal_value_spec.rb
...
- [x] core/symbol/dup_spec.rb
- [x] core/symbol/element_reference_spec.rb
...
- [ ] core/thread/backtrace/location/source_range_spec.rb
- [ ] core/thread/backtrace/location/syntax_tree_spec.rb
...
- [x] core/time/tuesday_spec.rb
- [x] core/time/tv_nsec_spec.rb
- [x] core/time/tv_sec_spec.rb
- [x] core/time/tv_usec_spec.rb
...
- [x] core/unboundmethod/bind_call_spec.rb
...
- [ ] core/unboundmethod/source_range_spec.rb
- [ ] core/unboundmethod/super_method_spec.rb
- [ ] core/unboundmethod/syntax_tree_spec.rb
- [x] core/unboundmethod/to_s_spec.rb
...
- [ ] library/socket/ipsocket/inspect_spec.rb
